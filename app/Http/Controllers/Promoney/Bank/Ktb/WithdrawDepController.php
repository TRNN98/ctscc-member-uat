...
class WithdrawDepController extends Controller
{
    private $client;
    private $headers;
    ...
    public function inquiry(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            // 'to_bay_account_no' => 'required',
            'transaction_amount' => 'required',
        ]);

        $url = "/ktb/dco/transaction/Inquiry/";
    ...
    public function confirmation(Request $request)
    {
        ...
        $url = "/ktb/dco/transaction/confirmations/";
        $transactionType = 'withdraw';
        $user = Auth::user()->MemRegis;
        ...
        $data = [
            ...
            'from_bay_account_no' => '',
            'to_coop_account_no' => '',
            'to_bay_account_no' => $request->to_bay_account_no,
            'transaction_amount' => $request->transaction_amount,
            'transaction_fee' => 0,
            'note' => $request->note ? $request->note : '',
        ...
        $this->headers['Authorization'] = 'Bearer ' . $request->header('coop-access-token');
        // $this->headers['bay-access-token'] = $request->header('bay-access-token');

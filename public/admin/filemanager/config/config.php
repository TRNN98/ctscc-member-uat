...
// use App\Model\admin\admin as admin;
...
$config = array(
    ...
    */
    ...
    |
    */
    // 'thumbs_base_path' => '../../mediafiles/thumbs/',
    ...
    |
    */
    // 'thumbs_upload_dir' => '../../mediafiles/thumbs/',
    ...
    */
    ...
    'access_keys' => array(md5(Auth::guard('admin')->user()->password)),

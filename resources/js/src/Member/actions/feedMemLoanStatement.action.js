import { MemLoanStatementConstant } from '../constants';
...
const fetching = (bool) => {
    return {
        type: MemLoanStatementConstant.FEED_REQUEST,
        fetching: bool
    }
};
...
const fetchSuccess = (data) => {
    return {
        type: MemLoanStatementConstant.FEED_SUCCESS,
        payload: data
    }
}
...
const fetchFailure = (bool) => {
    ...
    return {
        type: MemLoanStatementConstant.FEED_FAILURE
    }
}

export const feedMemLoanStatementActions = {
    feedDataGet,
    feedDataPost
    // feedHomepage,
}
